  ...
  return createPortal(
    ...
    >
      <div
        ...
        className="equipamento-modal flex max-h-[min(94dvh,820px)] w-full max-w-4xl flex-col overflow-hidden rounded-t-2xl border border-slate-800 bg-slate-950 shadow-2xl sm:rounded-2xl"
      >
