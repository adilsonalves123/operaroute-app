        ...
        <div className="relative flex flex-col gap-5 sm:flex-row sm:items-end sm:justify-between">
          <div className="max-w-lg">
            ...
            <p className="mt-2 text-sm text-slate-400 leading-relaxed">
              Monte o percurso do dia, atribua ao ajudante e acompanhe o progresso — no app e no
              WhatsApp.
            </p>
          </div>
          <button
                ...
                <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                  ...
                  <div className="flex flex-wrap gap-2 shrink-0">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 rounded-lg border border-slate-600 px-3 py-2 text-xs font-medium text-slate-200 hover:bg-slate-800"
                    >
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 rounded-lg border border-emerald-500/30 bg-emerald-500/10 px-3 py-2 text-xs font-medium text-emerald-300 hover:bg-emerald-500/15"
                    >
