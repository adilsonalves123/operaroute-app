    ...
    <div className="mx-auto flex min-h-screen max-w-md flex-col justify-center px-4 py-12">
      ...
      <form onSubmit={submit} className="space-y-3">
        <input
          ...
          className="w-full rounded-xl border border-white/10 bg-white/[0.03] px-4 py-3 text-[14px] text-white outline-none focus:border-[#c4a574]/40"
        />
        <input
          type="password"
          required
      ...
      <p className="mt-6 text-center text-[12px] text-slate-600">
        <Link href="/dono/login" className="hover:text-slate-400">
          Acesso do dono
        </Link>
      </p>
    </div>
