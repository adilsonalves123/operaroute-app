      ...
      <div className="space-y-4">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <p className="text-[12px] text-slate-500">
            Portal do parceiro:{" "}
            <Link href="/parceiro" className="underline hover:text-slate-300">
              /parceiro
            </Link>
        ...
        {showForm && (
          <form onSubmit={criar} className={cn(card, "grid gap-3 sm:grid-cols-2")}>
            ...
            <button
              type="submit"
              disabled={saving}
              className="sm:col-span-2 rounded-xl border border-[#c4a574]/40 bg-[#c4a574]/15 px-4 py-2.5 text-[13px] text-[#e8d5b0] disabled:opacity-50"
            >
        ...
        {loading ? (
          ...
          <div className={cn(card, "text-[13px] text-slate-500")}>
              ...
              <tbody className="divide-y divide-white/[0.04]">
                {itens.map((a) => (
                  <tr key={a.id} className="hover:bg-white/[0.015]">
                    ...
                    <td className="px-4 py-3 tabular-nums text-[#e8d5b0]">
