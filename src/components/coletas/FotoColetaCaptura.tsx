      ...
      {menuAberto ? (
        <div className="overflow-hidden rounded-xl border border-at-soft bg-slate-900/95 shadow-xl">
          ...
          <button
            ...
            className="flex w-full items-center gap-3 px-4 py-3.5 text-left text-sm text-slate-100 transition hover:bg-at-card-soft disabled:opacity-50"
          >
          ...
          <button
            ...
            className="flex w-full items-center gap-3 border-t border-at px-4 py-3.5 text-left text-sm text-slate-100 transition hover:bg-violet-500/10 disabled:opacity-50"
          >
          ...
          <button
            ...
            className="w-full border-t border-at px-4 py-2.5 text-center text-xs text-at-muted hover:text-at-primary/85"
          >
            Cancelar
          </button>
        </div>
