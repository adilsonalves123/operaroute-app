  ...
  return (
    <div className={cn("space-y-4", className)}>
      ...
      <section className="grid grid-cols-3 gap-2 sm:gap-3">
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-900/50 p-3 sm:p-4">
          <p className="flex items-center gap-1 text-xs font-medium uppercase tracking-wide text-slate-500 sm:text-sm">
            <BadgePercent className="hidden h-3.5 w-3.5 sm:block" />
            Comissão
