...
export function CorrigirPagamentoButton({
  ...
  return (
    <div className={cn("space-y-2", className)}>
      ...
      {open && (
        <div className="corrigir-pagamento-painel rounded-xl border border-white/10 bg-slate-950/80 p-4 space-y-3">
          <div>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              className="corrigir-pagamento-cancelar rounded-lg border border-slate-700 px-3.5 py-2 text-sm text-slate-400 hover:text-white"
            >
              Cancelar
            </button>
          </div>
