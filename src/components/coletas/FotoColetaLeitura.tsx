      ...
      {preview ? (
        <div className="relative space-y-2">
          ...
          <button
            ...
            className="flex w-full items-center justify-center gap-2 rounded-xl border border-slate-600 px-3 py-2.5 text-sm text-slate-300 hover:border-[#c4a574]/50 hover:text-[#e8d5b0] disabled:opacity-50"
          >
        ...
        <button
          ...
          className={cn(
            ...
            erroExibido
              ...
              : "border-slate-600 text-slate-400 hover:border-[#c4a574]/50 hover:text-[#e8d5b0]",
            buttonClassName
          )}
        >
