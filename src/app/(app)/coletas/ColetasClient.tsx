...
function hrefForColeta(coleta: ColetaWithPonto): string | null {
  ...
  if (coleta.nicho_modulo === NICHO_MODULO_CONSIGNADO) return `/coletas/consignado/${coleta.id}`;
  return null;
}
...
function accentForColeta(coleta: ColetaWithPonto, pendente: boolean): string {
  ...
  if (coleta.nicho_modulo === NICHO_MODULO_CONSIGNADO) return "bg-amber-300/90";
