...
import { alocarBrindeCentralParaMaquina } from "@/lib/estoque/transferir-maquina";
...
export async function POST(
  ...
  const result = await alocarBrindeCentralParaMaquina(supabase, {
  ...
  return NextResponse.json({
    success: true,
    mensagem: "Brinde adicionado na máquina.",
